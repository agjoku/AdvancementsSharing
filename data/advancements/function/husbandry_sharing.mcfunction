...
execute if entity @a[advancements={husbandry/break_netherite_hoe=true}] run advancement grant @a[advancements={husbandry/break_netherite_hoe=false}] only husbandry/obtain_netherite_hoe
